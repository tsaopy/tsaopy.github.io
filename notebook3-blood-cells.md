...
<img src="https://raw.githubusercontent.com/tsaopy/tsaopy.github.io/main/assets/nb3/nb3_pic1.png" width="700">
...
```
x0_prior = tsaopy.tools.uniform_prior(-500,50)
v0_prior = tsaopy.tools.uniform_prior(-200.0,2000.0)
a1_prior = tsaopy.tools.normal_prior(0.0,1000.0)
b1_prior = tsaopy.tools.normal_prior(0.0,1000.0)
```
...
```
f_prior = tsaopy.tools.uniform_prior(0.0,50000.0)
w_prior = tsaopy.tools.uniform_prior(0.0,100.0)
p_prior = tsaopy.tools.uniform_prior(-np.pi,np.pi)
```
...
```
<img src="https://raw.githubusercontent.com/tsaopy/tsaopy.github.io/main/assets/nb3/nb3_pic2.png" width="900">
<img src="https://raw.githubusercontent.com/tsaopy/tsaopy.github.io/main/assets/nb3/nb3_pic3.png" width="900">
...
```
tsaopy.tools.cornerplots(flat_samples[500*700,:],label_list)
```
<img src="https://raw.githubusercontent.com/tsaopy/tsaopy.github.io/main/assets/nb3/nb3_pic4.png" width="900">
...
```
x0_prior = tsaopy.tools.uniform_prior(-300,-20)
v0_prior = tsaopy.tools.uniform_prior(750,3000.0)
a1_prior = tsaopy.tools.normal_prior(0.0,1000.0)
b1_prior = tsaopy.tools.normal_prior(0.0,1000.0)
f_prior = tsaopy.tools.uniform_prior(0.0,50000.0)
...
tsaopy.tools.cornerplots(flat_samples,label_list)
```
<img src="https://raw.githubusercontent.com/tsaopy/tsaopy.github.io/main/assets/nb3/nb3_pic5.png" width="900">
...
tsaopy.tools.cornerplots(flat_samples,label_list)
```
<img src="https://raw.githubusercontent.com/tsaopy/tsaopy.github.io/main/assets/nb3/nb3_pic6.png" width="900">
...
```
<img src="https://raw.githubusercontent.com/tsaopy/tsaopy.github.io/main/assets/nb3/nb3_pic9.png" width="900">
...
<img src="https://raw.githubusercontent.com/tsaopy/tsaopy.github.io/main/assets/nb3/nb3_pic10.png" width="900">
<img src="https://raw.githubusercontent.com/tsaopy/tsaopy.github.io/main/assets/nb3/nb3_pic11.png" width="900">
